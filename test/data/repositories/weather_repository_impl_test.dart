...
import 'package:boilerplate/features/weather/data/repositories/weather_repository_impl.dart';
...
void main() {
  ...
  group('get current weather', () {
    ...
    test(
      ...
      () async {
        // arrange
        when(mockWeatherRemoteDataSource.getCurrentWeather(testCityName)).thenThrow(ApiException("Exception"));
